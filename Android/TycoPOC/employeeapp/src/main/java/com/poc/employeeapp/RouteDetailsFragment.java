 ...
 * {@link RouteDetailsFragment.OnFragmentInteractionListener} interface
...
public class RouteDetailsFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mShowRoute = (Button) v.findViewById(R.id.show_route);
        return v;
    }
    ...
    public void onStart() {
        super.onStart();
        mShowRoute.setOnClickListener(this);
    }
    ...
    public void onClick(View view) {
        Intent routeIntent = new Intent(getActivity(), MapWaypoints.class);
